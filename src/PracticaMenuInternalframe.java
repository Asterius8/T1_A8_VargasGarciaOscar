	...
	public VentanaInicio() {
		...
		//Barra de herramientas de acceso rapido
			JToolBar toolBar = new JToolBar(JToolBar.HORIZONTAL);
				...
				JButton btnadd = new JButton( "  Add  ",new ImageIcon("./assets/iconos/add.png") );
				btnadd.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnadd.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnadd);
				
				JButton btnEdit = new JButton( "  Edit  ",new ImageIcon("./assets/iconos/edit.png") );
				btnEdit.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnEdit.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnEdit);
				
				JButton btnBack = new JButton( " Back ",new ImageIcon("./assets/iconos/Back.png") );
				btnBack.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnBack.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnBack);
				
				JButton btnNext = new JButton( " Next ",new ImageIcon("./assets/iconos/Next.png") );
				btnNext.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnNext.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnNext);
				
				JButton btnList = new JButton( "  List  ",new ImageIcon("./assets/iconos/List.png") );
				btnList.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnList.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnList);
				
				JButton btnSave = new JButton( " Save ",new ImageIcon("./assets/iconos/Save.png") );
				btnSave.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnSave.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnSave);
				
				JButton btnPrint = new JButton( " Print ",new ImageIcon("./assets/iconos/Print.png") );
				btnPrint.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnPrint.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnPrint);
				
				JButton btnTest = new JButton( " Test ",new ImageIcon("./assets/iconos/Test.png") );
				btnTest.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnTest.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnTest);
				
				JButton btnCancel = new JButton( "Cancel",new ImageIcon("./assets/iconos/Cancel.png") );
				btnCancel.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnCancel.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnCancel);
				
				JButton btnSettings = new JButton( "Settings",new ImageIcon("./assets/iconos/Settings.png") );
				btnSettings.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnSettings.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnSettings);
				
				JButton btnDelete = new JButton( "Delete",new ImageIcon("./assets/iconos/Delete.png") );
				btnDelete.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnDelete.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnDelete);
				
				JButton btnSlip = new JButton( "  Slip   ",new ImageIcon("./assets/iconos/Slip.png") );
				btnSlip.setVerticalTextPosition(SwingConstants.BOTTOM);
				btnSlip.setHorizontalTextPosition(SwingConstants.CENTER);
				toolBar.add(btnSlip);
				
				JButton btnExit = new JButton( "  Exit   ",new ImageIcon("./assets/iconos/Exit.png") );
		...
		JDesktopPane desktopPane = new JDesktopPane();
			...
			internalFrameTarea.setSize(685, 650);
			...
			metodoAcomodoPanel(lblP1_1,0,0,1,1, gbl, gbc, panel1);
			JTextField txtP1_1 = new JTextField(7);
			metodoAcomodoPanel(txtP1_1,1,0,2,1, gbl, gbc, panel1);
			
			JLabel lblP1_2 = new JLabel("Date");
			metodoAcomodoPanel(lblP1_2,4,0,1,1, gbl, gbc, panel1);
			JComboBox comboP1_1 = new JComboBox<String>();
			comboP1_1.addItem("02/12/2012");
			metodoAcomodoPanel(comboP1_1,6,0,3,1, gbl, gbc, panel1);
			
			JLabel lblP1_3 = new JLabel("* Time(hh:mm)");
			metodoAcomodoPanel(lblP1_3,9,0,1,1, gbl, gbc, panel1);
			JTextField txtP1_2 = new JTextField("0",2);
			metodoAcomodoPanel(txtP1_2,10,0,1,1, gbl, gbc, panel1);
			JLabel lblP1_4 = new JLabel(":");
			metodoAcomodoPanel(lblP1_4,11,0,1,1, gbl, gbc, panel1);
			JTextField txtP1_3 = new JTextField("0",2);
			metodoAcomodoPanel(txtP1_3,12,0,1,1, gbl, gbc, panel1);
			
			JLabel lblP1_5 = new JLabel("Lab No");
			metodoAcomodoPanel(lblP1_5,14,0,1,1, gbl, gbc, panel1);
			JTextField txtP1_4 = new JTextField(7);
			metodoAcomodoPanel(txtP1_4,15,0,2,1, gbl, gbc, panel1);
			
			JLabel lblP1_6 = new JLabel("Name");
			metodoAcomodoPanel(lblP1_6,0,1,1,1, gbl, gbc, panel1);
			JComboBox comboP1_2 = new JComboBox<String>();
			comboP1_2.addItem("MR.");
			metodoAcomodoPanel(comboP1_2,1,1,1,1, gbl, gbc, panel1);
			JTextField txtP1_5 = new JTextField();
			metodoAcomodoPanel(txtP1_5,2,1,6,1, gbl, gbc, panel1);
			
			JLabel lblP1_7 = new JLabel("Sex");
			metodoAcomodoPanel(lblP1_7,0,2,1,1, gbl, gbc, panel1);
			JComboBox comboP1_3 = new JComboBox<String>();
			comboP1_3.addItem("MALE");
			metodoAcomodoPanel(comboP1_3,1,2,1,1, gbl, gbc, panel1);
			
			JLabel lblP1_8 = new JLabel("Age");
			metodoAcomodoPanel(lblP1_8,2,2,1,1, gbl, gbc, panel1);
			JTextField txtP1_6 = new JTextField("0",2);
			metodoAcomodoPanel(txtP1_6,3,2,1,1, gbl, gbc, panel1);
			
			JLabel lblP1_9 = new JLabel("Mons");
			metodoAcomodoPanel(lblP1_9,4,2,1,1, gbl, gbc, panel1);
			JTextField txtP1_7 = new JTextField("0",2);
			metodoAcomodoPanel(txtP1_7,5,2,1,1, gbl, gbc, panel1);
			
			JLabel lblP1_10 = new JLabel("Days");
			metodoAcomodoPanel(lblP1_10,6,2,1,1, gbl, gbc, panel1);
			JTextField txtP1_8 = new JTextField("0",2);
			metodoAcomodoPanel(txtP1_8,7,2,1,1, gbl, gbc, panel1);

			JLabel lblP1_11 = new JLabel("Sample By");
			metodoAcomodoPanel(lblP1_11,9,2,1,1, gbl, gbc, panel1);
			JTextField txtP1_9 = new JTextField(8);
			metodoAcomodoPanel(txtP1_9,10,2,4,1, gbl, gbc, panel1);
			
			JLabel lblP1_12 = new JLabel("Referred By");
			metodoAcomodoPanel(lblP1_12,0,3,1,1, gbl, gbc, panel1);
			JTextField txtP1_10 = new JTextField();
			metodoAcomodoPanel(txtP1_10,1,3,2,1, gbl, gbc, panel1);
			JTextField txtP1_11 = new JTextField();
			txtP1_11.setEditable(false);
			metodoAcomodoPanel(txtP1_11,4,3,4,1, gbl, gbc, panel1);


			JLabel lblP1_13 = new JLabel("Panel Code");
			metodoAcomodoPanel(lblP1_13,9,3,1,1, gbl, gbc, panel1);
			JTextField txtP1_12 = new JTextField(8);
			metodoAcomodoPanel(txtP1_12,10,3,4,1, gbl, gbc, panel1);

			JLabel lblP1_14 = new JLabel("Panel ID");
			metodoAcomodoPanel(lblP1_14,9,4,1,1, gbl, gbc, panel1);
			JTextField txtP1_13 = new JTextField(8);
			metodoAcomodoPanel(txtP1_13,10,4,4,1, gbl, gbc, panel1);

			JLabel lblP1_15 = new JLabel("e-mail");
			metodoAcomodoPanel(lblP1_15,9,5,1,1, gbl, gbc, panel1);
			JTextField txtP1_14 = new JTextField(8);
			metodoAcomodoPanel(txtP1_14,10,5,4,1, gbl, gbc, panel1);
...
public class PracticaMenuInternalframe {
